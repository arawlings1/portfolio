...
## Neighborhoods by number of historical markers
...
## Bike racks within walking distance of historical markers
...
[![](thumbnails/mex_urbanextent.png)](https://arawlings1.github.io/portfolio/fullsize/mex_urbanextent.png.pdf){target="_blank"}

# Transportation Networks- Portland, OR

## Walking travel time to the nearest grocery store
## Transit travel time to the nearest farmer's market
## Pedestrian access to food

# Interactive Maps- Idaho, USA

## Public assistance receipt across Idaho counties
